import {
  ViroAnimations, ViroARScene, ViroMaterials, ViroTrackingStateConstants
...
const MeasureSceneAR = (props) => {
  ...
  const lineRef1 = React.useRef(null);
  const lineRef2 = React.useRef(null);
  const lineRef3 = React.useRef(null);
          ...
          if (result.type == 'ExistingPlaneUsingExtent') {
            ...
            if (firstNodePlaced) {
              if(pointStep === 2) {
                ...
                nodeRef5.current.getTransformAsync().then(transform => {
  ...
  const getDistance = (positionOne, positionTwo, lineNumber) => {
  ...
  return (
    <ViroARScene
      ...
      onClick={() => {}}
      >
      <LineView key={'1'} customRef1={nodeRef1} customRef2={nodeRef2} lineCustomRef={lineRef1} point1={point.point1} point2={point.point2} distance={distance.line1|| 0} />
      <LineView key={'2'} customRef1={nodeRef3} customRef2={nodeRef4} lineCustomRef={lineRef2} point1={point.point3} point2={point.point4} distance={distance.line2|| 0} />
      <LineView key={'3'} customRef1={nodeRef5} customRef2={nodeRef6} lineCustomRef={lineRef3} point1={point.point5} point2={point.point6} distance={distance.line3|| 0} />
    </ViroARScene>
  );
};
